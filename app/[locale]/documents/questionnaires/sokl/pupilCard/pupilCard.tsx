...
import { Count, SoklPupilCardResult } from '@/utils/reports/sokl/card/card.model';
...
export default function PupilCard({
  ...
  result: SoklPupilCardResult;
}) {
  Font.register(documentFontOptions);

  const t = useTranslations('documents.questionnaires.sokl.pupil_card');
