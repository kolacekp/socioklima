...
import { Count, SoklSocialIndexResult } from '@/utils/reports/sokl/index/index.model';

export default function SocialInvolvementIndex({ result }: { result: SoklSocialIndexResult }) {
  const genderRequired = result.info.genderRequired;

  Font.register(documentFontOptions);

  const t = useTranslations('documents.questionnaires.sokl.social_involvement_index');
