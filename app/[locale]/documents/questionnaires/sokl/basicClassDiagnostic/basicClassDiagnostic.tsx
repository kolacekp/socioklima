...
import { categoriesArray, indexesArray } from '@/utils/categories';
import { documentFontOptions } from '../../../fonts';
import { Categories, Count, Options } from '@/utils/reports/sokl/bcd/bcd.model';
...
export default function BasicClassDiagnostic({
  ...
  const t = useTranslations('documents.questionnaires.sokl.basic_class_diagnostic');
        ...
        <Page size="A4" style={styles.page}>
          ...
          <View style={styles.section}>
            ...
            <View style={{ flexDirection: 'row', marginBottom: 3 }}>
              ...
              <PdfColumn width="80%">
                <Text>{tQ(info.questionnaireName)}</Text>
              </PdfColumn>
            </View>
            <View style={{ flexDirection: 'row', marginBottom: 3 }}>
              <PdfColumn width="20%">
