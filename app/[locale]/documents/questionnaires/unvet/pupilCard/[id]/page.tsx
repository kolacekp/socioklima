...
import { getUnvetPupilCardResult } from '@/utils/reports/unvet/card/card';
...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: 'documents.questionnaires.unvet.pupil_card' });
...
export default async function PupilCardPDF({
  ...
  const result = await getUnvetPupilCardResult(params.id, searchParams.pupil);
