...
import {
  ...
  OptionsCountsPupils,
  UnvetDcdResult
} from '@/utils/reports/unvet/dcd/dcd.model';

export default function DetailClassDiagnostic({ barChart, result }: { barChart: string; result: UnvetDcdResult }) {
      ...
      <Document pageLayout="oneColumn">
        <Page size="A4" style={styles.page}>
          ...
          <View style={styles.section} break>
            ...
            <Text style={styles.subsubheading}>{t('graph')}</Text>
