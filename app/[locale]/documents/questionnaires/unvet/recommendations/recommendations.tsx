...
import { UnvetRecommendationsResult } from '@/utils/reports/unvet/recommendations/recommendations.model';

export default function Recommendations({ result }: { result: UnvetRecommendationsResult }) {
  Font.register(documentFontOptions);

  const t = useTranslations('documents.questionnaires.unvet.recommendations');
