...
import { CategoriesCountsPupils, OptionsCountsPupils, SoklDcdeResult } from '@/utils/reports/sokl/dcde/dcde.model';

export default function DetailClassDiagnosticExtract({ result }: { result: SoklDcdeResult }) {
