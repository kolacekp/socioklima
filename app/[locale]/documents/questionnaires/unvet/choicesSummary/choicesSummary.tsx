...
import { Options, UnvetChoicesSummaryResult } from '@/utils/reports/unvet/choices/choices.model';

export default function ChoicesSummary({ result }: { result: UnvetChoicesSummaryResult }) {
  Font.register(documentFontOptions);

  const t = useTranslations('documents.questionnaires.unvet.choices_summary');
