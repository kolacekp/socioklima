...
import { PkzCommentsResult } from '@/utils/reports/pkz/comments/comments.model';

export default function CommentsPupil({ result }: { result: PkzCommentsResult }) {
  Font.register(documentFontOptions);

  const t = useTranslations('documents.questionnaires.pkz.comments');
  ...
  const tQuestions = useTranslations('questionnaires.pkz.questions');
